...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('order_bot_settings', function (Blueprint $table) {
            ...
            $table->boolean('telegram_bot')->default(false); // Path to the CSV file
            $table->boolean('unlimited_orders')->default(false); // Path to the CSV file
            $table->boolean('shopify_bot')->default(false); // Path to the CSV file
            $table->timestamps();
        });
    }
